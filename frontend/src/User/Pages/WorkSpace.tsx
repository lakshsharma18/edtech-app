...
const WorkSpace = () => {
        ...
        const loadCourse = async()=>{
            ...
            try{
                ...
                const [
                    ...
                    API.get(
                        `/api/v1/live/check-active-stream/${courseId}`
                    )
                    .catch(()=>({
                        data:{
                            live_active:false
                ...
                if(enrolled){
                    ...
                    setBackendLiveStatus(
                        liveRes.data?.live_active || false
                    );
                    ...
                    if(progress === 100){
                        ...
                        try{
                            ...
                            const quiz =
                            await API.get(
                                `/api/v1/quiz/attempts/${courseId}`
                            );


                            setQuizPassed(
                                quiz.data?.passed || false
                            );
                    ...
                    // AUTO JOIN LIVE CLASS

                    if(
                        searchParams.get("joinLive")
                        ===
                        "true"
                        ||
                        liveRes.data?.live_active
                    ){
    ...
    const joinLiveClass = async () => {
        ...
        const ws = new WebSocket(
            ...
            `wss://edtech-backend-gne3.onrender.com/api/v1/live/ws/${id}`
        ...
        try{
            ...
            const res =
                await API.post(
                    ...
                    `/api/v1/create-checkout-session/${id}`
        ...
        <div className="bg-light min-vh-100 py-4">
            ...
            <Container fluid="lg">
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    {
                        isEnrolled &&
                        (backendLiveStatus || isLiveActive) &&
...

                        {
                            ...
                            <>
                                ...
                                <Card
                                    ...
                                    className="ratio ratio-16x9 bg-black overflow-hidden rounded-4 border-0 shadow-sm mb-4"
                                            ...
                                            >
                                                ...
                                                <div className="d-flex align-items-center gap-2">
...

                                                    {
                                                        ...
                                                        <FaPlayCircle className="text-muted"/>
