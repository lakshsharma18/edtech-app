...
export const NotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <NotificationContext.Provider
            value={{
                activeNotification: alertData?.course_title || null
            }}
        >
            {children}
            ...
            >
                ...
                >
                    <Toast.Header className="bg-dark text-white">
                        ...
                        <strong className="me-auto">🔴 Lecture Live</strong>
                    </Toast.Header>

                    <Toast.Body className="bg-dark text-white">
                        <p className="small text-white-50">
                            Instructor <strong>{alertData?.instructor_name}</strong> started a live class.
                        </p>

                        <h6 className="text-info fw-bold">{alertData?.course_title}</h6>
