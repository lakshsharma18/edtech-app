...
const InstructorLive = () => {
    ...
    const cleanupStream = async () => {
        ...
        if(course_id){
            ...
            try{
                ...
                await API.post(
                    `/api/v1/live/end-class/${course_id}`
                );
    ...
    const startLiveBroadcast = async()=>{
        ...
        try{
            ...
            await API.post(
                `/api/v1/live/start-class/${course_id}`
            );
            ...
            new WebSocket(
                ...
                `${WS_URL}/api/v1/live/ws/${course_id}`
            ...
            socketRef.current.onopen=()=>{
                ...
                console.log(
                    "Instructor websocket connected"
                );
    ...
    const handleExitStudio=()=>{
        ...
        navigate(
            `/instructor/manage-course/${course_id}`
        );
    ...
    return (
        ...
        <Container>
            ...
            <Card
            className="p-5 text-center mt-4"
            >

            <Badge
            bg={isStreaming?"danger":"secondary"}
            >
